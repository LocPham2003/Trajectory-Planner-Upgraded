...
public class Constants {
    // Constant for computing the floating point difference between 2 coordinates
    public static final double COORDINATE_FLOAT_DIFF = 0.00001;
    public static final double MENU_BAR_SHIFT = 27.5;
    public static final double CURSOR_SHIFT = 25.0;
